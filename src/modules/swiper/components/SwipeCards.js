...
export default class SwipeCards extends Component {
  ...
  renderStack() {
    ...
    return cards.map((card, i) => {
      ...
      //TODO: stack view not working with the below styles --- need to revise
      if (i + 1 === cards.length) {
        ...
        console.log("translateX: " + JSON.stringify(translateX, null, 4) + ", translateY: " + JSON.stringify(translateY, null, 4) + ", roatate: " + JSON.stringify(rotate, null, 4) + ", scale: " + JSON.stringify(scale, null, 4) + ", opacity: " + JSON.stringify(opacity, null, 4));
        ...
        return <Animated.View key={i.toString()} style={[styles.card, animatedCardStyles]} {... this._panResponder.panHandlers}>
      ...
      return <Animated.View key={i.toString()} style={style}>{this.props.renderCard(card)}</Animated.View>;
    });
  }
